  ...
  render() {
    ...
    return (
      <div id="Canvas">
        ...
        <Button onClick={this.addText} startIcon={<Add />}>
          Add Text
        </Button>
        <div>
          <FormControlLabel
            control={<Checkbox />}
            label="Bold"
            onChange={(e) => this.onBold(e)}
          />
          <FormControlLabel
            control={<Checkbox />}
            label="Italic"
            onChange={(e) => this.onItalic(e)}
          />
          <FormControlLabel
            control={<Checkbox />}
            label="Underline"
            onChange={(e) => this.onUnderline(e)}
          />
          <FormControlLabel
            control={<Checkbox />}
            label="Linethrough"
            onChange={(e) => this.onLinethrough(e)}
          />
          <FormControlLabel
            control={<Checkbox />}
            label="Overline"
            onChange={(e) => this.onOverline(e)}
          />
        </div>
        <div>
